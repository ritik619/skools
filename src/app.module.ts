...
@Module({
  imports: [AuthModule,OrgnaizationModule, CountryModule, CityModule, StateModule, SchoolModule, AcademicYearModule, GradeModule, SectionModule, RoomModule, SchoolDocumentModule, DocumentTemplateModule, UserModule, UserRoleHierarchyModule, UserRelationshipModule, UserRoleModule],
